...
<body class="@yield('body-class')">
	...
	<nav class="navbar navbar-transparent navbar-absolute">
    	...
    	<div class="container">
        	...
        	<div class="collapse navbar-collapse" id="navigation-example">
				...
				<li class="nav-item">
                    <a class="nav-link" href="{{ url('/conocenos') }}">
					Contáctanos
                    </a>
                </li>
				<li class="nav-item">
						...
						<li class="nav-item">
                            ...
                            <li class="dropdown">
								...
								@if (auth()->user()->admin)
									<li>
										<a href="{{ url('/admin/artists') }}">Gestionar Artistas</a>
									</li>
									<li>
										<a href="{{ url('/admin/types') }}">Gestionar Tipos</a>
									</li>
									<li>
										<a href="{{ url('/admin/genres') }}">Gestionar Género</a>
									</li>
									<li>
										<a href="{{ url('/admin/techniques') }}">Gestionar Técnicas</a>
									</li>
									<li>
    ...
    <div class="wrapper" style="background: #575c62;">
