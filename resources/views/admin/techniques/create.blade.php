...
<div class="main main-raised">
    <div class="container">
        <div class="section">
            <h2 class="title text-center">Registrar Técnica</h2>
                ...
                <form method="POST" action="{{ url('/admin/techniques') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ url('/admin/techniques') }}" class="btn btn-danger"><i class="material-icons">cancel</i>Cancelar</a>
                    </div> 
